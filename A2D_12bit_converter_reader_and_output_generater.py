...
from continuous_range_and_number_of_readings_finder import get_continuous_range_and_number_of_readings_and_generate_output
...
def read_12bit_A2D_converter_and_generate_output(samples):
    ...
    continuous_range, number_of_readings = get_continuous_range_and_number_of_readings_and_generate_output(current_samples)
