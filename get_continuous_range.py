...
def create_continuous_range_and_number_of_readings(continuous_range, number_of_readings, samples):
...
def get_continuous_range_and_number_of_readings(samples):
    ...
    if (check_input_data_is_valid(samples)):
        continuous_range, number_of_readings = create_continuous_range_and_number_of_readings(continuous_range, number_of_readings, samples)
    return (continuous_range, number_of_readings)
